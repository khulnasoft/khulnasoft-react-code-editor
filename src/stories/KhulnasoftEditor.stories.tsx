...
import { KhulnasoftEditor } from '../components';
import { Document, Language } from '../models';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta: Meta<typeof KhulnasoftEditor> = {
  title: 'Example/Editor',
  component: KhulnasoftEditor,
  parameters: {
  ...
  argTypes: {},
} satisfies Meta<typeof KhulnasoftEditor>;
...
// Khulnasoft's generation will take this context into account when suggesting.
